...
public class ServerBaseException extends RuntimeException {
     ...
     */
    public ServerBaseException(ApiResponseCode responseCode, HttpStatus httpStatus) {
     ...
     */
    public ServerBaseException(ApiResponseCode responseCode, HttpStatus httpStatus, String customMessage) {
        super(customMessage);
        this.responseCode = responseCode;
        this.httpStatus = httpStatus;
        this.metadata = new HashMap<>();
     ...
     */
    public ServerBaseException(ApiResponseCode responseCode, HttpStatus httpStatus, Throwable cause) {
     ...
     */
    public ServerBaseException(ApiResponseCode responseCode, HttpStatus httpStatus, String customMessage, Throwable cause) {
     ...
     */
    public ServerBaseException withMetadata(String key, Object value) {
     ...
     * @return this for method chaining
     */
    public ServerBaseException withMetadata(Map<String, Object> metadata) {
